...
class ProductionSetting:
    ...
    :ivar production_setting_collected_in_research_project:
    ...
    production_setting_language_course_level: object = field(
...
class LanguageOfSpeaker:
    ...
    learner_language_is_spoken_home: Optional[Union[bool, NaString]] = field(
        default=None,
        metadata={
