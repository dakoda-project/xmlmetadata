...
class Annotation:
    """
    :ivar annotation_automatic: A related field in CMSLC is XXX.
    :ivar annotation_corrected: Was the automatic annotation subject to
        further correction? A related field in CMSLC is
        `annotation_corrected`.
    :ivar annotation_documentation: Plain text description of annotation
        or link to documentation A related field in CMSLC is
        annotation_documentation.
    :ivar annotation_evaluation: Was the annotation evaluated? A related
        field in CMSLC is `annotation_evaluation`.
    :ivar annotation_tool: Name of tool used for annotation A related
        field in CMSLC is `annotation_tool`.
    :ivar annotation_tool_version: Version of tool used for annotation A
        related field in CMSLC is `annotation_tool_version`.
    :ivar annotation_type: Specification of an annotation type such as
        lemma , POS, etc. A related field in CMSLC is `annotation_type`.
    """
    ...
    annotation_evaluation: Optional[bool] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class TrgLangInputType(Enum):
    ...
    HYBRID = "hybrid"
    UNCLEAR_OTHER_CONTEXTS = "unclear/other contexts"
...
class WordOrderType(Enum):
    ...
    SVO = "SVO"
    VSO = "VSO"
    SVO_OR_VSO = "SVO or VSO"
    SOV_OR_SVO = "SOV or SVO"
...
class CorpusAdministrative:
    """
    :ivar corpus_admin_acronym: Acronym of the source corpus. This field
        matches the CMSLC field `corpus_acronym`.
    :ivar corpus_admin_name: The fully spelled out title of the corpus.
        Can occur multiple times for corpora with official names in
        multiple languages. A comparable field in CMSLC is
        `corpus_name`.
    :ivar corpus_admin_author: Corpus creator. This field matches the
        CMSLC field `corpus_author`.
    :ivar corpus_admin_availability: Licensing terms and conditions for
        corpus. A comparable field name in CMSLC is
        `corpus_availability`
    :ivar corpus_admin_citation_document: Information on how excerpts of
        ...
        in CMSLC .
    :ivar corpus_admin_cite_as: How to cite this corpus: Author(s) or
        Responsible(s) (Year). Title of the data set (Version number):
        Distributor, Identifier or Location. This is typically generated
        by the data repository. This field name is shared with CMSLC.
    :ivar corpus_admin_contact_mail: Contact e-mail address . CMSLC has
        a matching field `corpus_contact_mail`.
    :ivar corpus_admin_contributor_dkd: One person of the set of
        contributors to the Dakoda project. CMSLC has the comparable
        field `corpus_contributor`.
    :ivar corpus_admin_contributor_orig: One person out of the set of
        contributors to the source project. CMSLC has the comparable
        field `corpus_contributor`.
    :ivar corpus_admin_date_of_publication: Publication year of the
        source version of the corpus. e.g. YYYY, YYYY-MM or YYYY-MM-DD.
        A comparable field name in CMSLC is `Date of publication`.
    :ivar corpus_admin_documentation: Link to more extensive corpus
        documentation. Usually a corpus manual including , for instance,
        the trancription and/or annotation guidelines. CMSLC has a
        matching field `corpus_documentation`.
    :ivar corpus_admin_file_format: A file format used for a component
        of the DAKODA corpus. A comparable field in CMSLC is
        `corpus_file_format`.
    :ivar corpus_admin_licence: The license type for the DAKODA-Version
        of the corpus. NB: the value type for thie element will become
        an enumeration of strings. A comparable field name in CMSLC is
        `corpus_licence`.
    :ivar corpus_admin_licence_fulltext: Licence text applicable to the
        DAKODA version of a corpus.
    :ivar corpus_admin_licence_url: Link to licence text, usually a URL
        such as http://creativecommons.org/licenses/by-sa/4.0/ A
        comparable field name in CMSLC is `corpus_licence_url`.
    :ivar corpus_admin_other_versions: Associated version of corpus.
        This will often be an earlier release of the corpus. A
        comparable field in CMSLC is `corpus_other_versions`.
    :ivar corpus_admin_pid_dkd: Persistent Identifier for the DAKODA-
        version of the corpus, typically a DOI or a handle such as
        http://hdl.handle.net/20.500.12124/25 A comparable field in
        CMSLC is `corpus_pid`. <xs:appinfo
        xmlns:xs="http://www.w3.org/2001/XMLSchema"><displayname
        xmlns="">PID (DAKODA-Version)</displayname></xs:appinfo>
    :ivar corpus_admin_pid_orig: Persistent Identifier for the source
        version of the corpus, typically a DOI or a handle such as
        http://hdl.handle.net/20.500.12124/25 A comparable field in
        CMSLC is `corpus_pid`.
    :ivar corpus_admin_ref_article: Specification of a reference
        article. Such articles typically contain an extensive verbal
        description of the corpus and its design. CMSLC has related
        metadata field `corpus_ref_article`.
    :ivar corpus_admin_references_other: Further important publications
        or links to the corpus . CMSLC has related metadata field
        `corpus_ref_article`.
    :ivar corpus_admin_research_paper: Specification of a
        publicationrelated to the original version of the corpus . CMSLC
        has related metadata field `corpus_ref_article`.
    :ivar corpus_admin_url_download: Link to corpus download for
        original version of corpus.
    :ivar corpus_admin_urlquery: Link to corpus query (original
        version).
    :ivar corpus_admin_version_orig: The version of the source corpus
        that forms the basis for the DAKODA version. A comparable field
        in CMSLC is `corpus_version`.
    """
    class Meta:
    ...
    corpus_admin_citation_document: Optional[str] = field(
        default=None,
        metadata={
...
class CorpusProficiency:
    ...
    :ivar corpus_proficiency_assignment_method: The method of
        ...
        field in CMSLC is `corpus_proficiency_assignment_method`.
    :ivar corpus_proficiency_is_assignment_available: specification of
        ...
        learner/L1 speakers or texts. A related field in CMSLC is
    ...
    corpus_proficiency_level: Optional[ProficiencyLevel] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class CorpusProject:
    ...
    :ivar corpus_project_contact_orig: Contact e-mail address of the
        source project (original version). CMSLC has a matching field
        `corpus_contact_mail`.
    ...
    :ivar corpus_project_institution_dkd: One of the institutions
        ...
        comparable field in CMSLC is `corpus_publisher`.
    :ivar corpus_project_institution_orig: Institutions responsible for
        ...
        degree-conferring one. A comparable field in CMSLC is
        `corpus_publisher`.
    ...
    :ivar corpus_project_type_dkd: Type of project that DAKODA
    ...
    corpus_project_name_orig: Optional[str] = field(
        default=None,
        metadata={
            "type": "Element",
        }
...
class CorpusSubcorpus:
    ...
    :ivar corpus_subcorpus_size_learners: The number of learners
        represented in the subcorpus. An equivalent field in CMSLC is
        `corpus_size_learners`.
    :ivar corpus_subcorpus_size_texts: The number of texts in the
        subcorpus. A related field in CMSLC is `corpus_size_texts`.
    :ivar corpus_subcorpus_size_tokens: The number of tokens in the
        subcorpus. A related field in CMSLC is `corpus_size_tokens`.
    :ivar corpus_subcorpus_target_language: Specification of the target
        ...
        field in CMSLC is `corpus_target_language`.
    """
    class Meta:
...
class LanguageExposure:
    ...
    :ivar learner_language_exposure_duration_of_instruction: Number of
        years of instruction of a foreign or second language. A related
        field in CMSCL is `learner_target_language_learning_context` .
    :ivar learner_language_exposure_duration_of_use: Number of years in
        ...
        time). A related field in CMSCL is
    ...
    :ivar learner_language_exposure_learning_context: ??? A related
        field in CMSLC is XXX.
    ...
    learner_language_exposure_onset: Optional[Union[int, NaString]] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    learner_language_exposure_duration_of_instruction: Optional[Union[int, NaString]] = field(
        default=None,
        metadata={
    ...
    learner_language_exposure_duration_of_use: Optional[Union[int, NaString]] = field(
        default=None,
        metadata={
    ...
    learner_language_exposure_months_spent_environment: Optional[Union[int, NaString]] = field(
        default=None,
        metadata={
...
class LearnerLanguageProficiency:
    ...
    :ivar learner_language_proficiency_score: learner/L1 speaker
        ...
        field in CMSLC is `learner_target_language_proficiency`.
    :ivar learner_language_proficiency_cefr: Learner/L1 speaker
        proficiency measured or converted as CEFR level. A related field
        in CMSLC is
        `learner_target_language_proficiency_CEFR_conversion`.
    :ivar learner_language_proficiency_c_test_cefr: Level of GeRS-
        related C-tests A related field in CMSLC is
        `learner_target_language_proficiency_CEFR_conversion`.
    :ivar learner_language_proficiency_c_test_level_detail: Detailed
        C-test level. A related field in CMSLC is
        `learner_target_language_proficiency`.
    :ivar learner_language_proficiency_c_test_percent: C-test result in
        per cent. A related field in CMSLC is
        `learner_target_language_proficiency`.
    :ivar learner_language_proficiency_c_test_type: Type of C-test . A
        related field in CMSLC is
        `corpus_learner_proficiency_assignment_instrument`.
    :ivar learner_language_proficiency_estimate_min: Approximate
        indication of the speaker's minimal language competence; based
        on GeR-related text assessment if possible. If not, based on
        C-test result or duration of use (0-2 years = A, 2-5 years = B,
        &gt;5 years = C) A related field in CMSLC is XXX.
    :ivar learner_language_proficiency_estimate_max: Approximate
        indication of the speaker's maximal language competence; based
        on GeR-related text assessment if possible. If not, based on
        C-test result or duration of use (0-2 years = A, 2-5 years = B,
        &gt;5 years = C) A related field in CMSLC is XXX.
    :ivar learner_language_proficiency_self_assessment: Self-assessment
        of German language skills. There is no related field in CMSLC .
    :ivar learner_language_proficiency_assignment_instrument: Name of
        instrument used to evaluate a speaker's proficiency. A related
        field in CMSLC is
        `corpus_learner_proficiency_assignment_instrument`.
    :ivar learner_language_proficiency_assignment_method: How was the
        proficiency of the learner/L1 speakers evaluated? How was the
        proficiency of the learner/L1 speakers evaluated?. A related
        field in CMSLC is
        `corpus_learner_proficiency_assignment_method`.
    :ivar learner_language_proficiency_documentation: Link to relevant
        documentation on how learner/L1 speakers were evaluated A
        related field in CMSLC is
        `corpus_learner_proficiency_documentation`.
    """
    class Meta:
...
class ProductionSetting:
    """
    :ivar production_setting_school_grade: School year, if any, in which
        the productions were collected. There is no related field in
        CMSLC.
    :ivar production_setting_educational_stage: Level of education the
        learners are currently in and have not yet completed There is a
        related field in CMSLC called `learner_educational_background`.
    :ivar production_setting_language_test: If the texts were collected
        ...
        name of the language test taken. CMSLC has a related field
        `corpus_language_testing_setting`.
    :ivar production_setting_language_course_level: Level of the
        language course currently attended. CMSLC has no related field .
    :ivar production_setting_naturalistic: Specification of setting for
        data collection , if outside of an institutional context.
        Possible values include e.g. work, family, friends, leisure. A
        related field in CMSLC is `situation_setting`.
    :ivar production_setting_in_research_project_collected:
        Specification of whether the data was collected as part of a
        research project.
    :ivar production_setting_setting: The context of the data collection
        effort. A comparable field in CMSLC is
    ...
    production_setting_educational_stage: Optional[EducationalStage] = field(
        default=None,
        metadata={
    ...
    production_setting_language_course_level: Optional[object] = field(
        default=None,
        metadata={
    ...
    production_setting_in_research_project_collected: Optional[bool] = field(
        default=None,
        metadata={
            "name": "productionSetting_inResearchProjectCollected",
            "type": "Element",
            "required": True,
        }
    )
...
class Proficiency:
    """
    :ivar corpus_production_setting_mode: Mode in which data production
        took place: spoken/oral or written. A related field in CMSLC is
        `corpus_mode`.
    :ivar corpus_mode: A medium in which (a part of) the corpus was
        realized. An eqivalent field in CMSLC is `corpus_mode`.
    :ivar corpus_task_type: Specification of the task type used in the
        corpus. A related field in CMSLC is `situation_register`.
    """
    corpus_production_setting_mode: List[DataProductionSettingMode] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
    ...
    corpus_mode: List[DataProductionSettingMode] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
    ...
    corpus_task_type: LearnerTaskType = field(
        default=LearnerTaskType.NOT_AVAILABLE,
        metadata={
            "name": "corpus_taskType",
            "type": "Element",
            "required": True,
        }
    )
...
class Sociodemographics:
    """
    :ivar learner_socio_birthplace: Place of birth of the speaker coded
        as country or territory. There is no related field in CMSCL.
    ...
    :ivar learner_socio_educational_background: Highest level of
        ...
        CMSLC called `learner_educational_background`.
    :ivar learner_socio_gender: learner/L1 speaker gender
    :ivar learner_socio_major_subject: (Major) subject at university
        There is no related field in CMSLC .
    :ivar learner_socio_profession: Occupation A related field in CMSLC
        is `learner_socioeconomic_status`.
    :ivar learner_socio_school_grade: School year in which the text was
        collected There is no related field in CMSLC .
    """
    learner_socio_birthplace: Optional[CountryType] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    learner_socio_country: Optional[CountryType] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    learner_socio_educational_background: Optional[EducationalStage] = field(
        default=None,
        metadata={
    ...
    learner_socio_gender: Optional[Gender] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
@dataclass
class TaskInteractionMode:
    """
    :ivar corpus_mode: The modality (e.g. spoken, written) .... An
        equivalent field in CMSLC is `???_mode`.
    :ivar situation_mode: The modality (e.g. spoken, written) in which
        the task was performed . An equivalent field in CMSLC is
        `situation_mode`.
    """
    class Meta:
        name = "Task_Interaction_Mode"
    ...
    situation_mode: List[DataProductionSettingMode] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
class TextAnnotation:
    """
    :ivar text_annotation_borrowed: Does the text contain annotations
        for structures taken from the task prompt? There is no related
        field in CMSLC .
    :ivar text_annotation_has_error_annotation: Is the text error-
        annotated? There is no related field in CMSLC .
    :ivar text_annotation_has_target_hypotheses: Is the text annotated
        with target hypotheses? There is no related field in CMSLC .
    """
    class Meta:
        name = "Text_Annotation"

    text_annotation_borrowed: Union[bool, NaString] = field(
    ...
    text_annotation_has_error_annotation: Union[bool, NaString] = field(
        default=NaString.NOT_AVAILABLE,
        metadata={
            "name": "text_annotation_hasErrorAnnotation",
            "type": "Element",
            "required": True,
        }
    )
...
class TextLearner:
    """
    :ivar text_learner_age_production: The age in years of the learner
        at the time of data collection. An equivalent field in CMSLC is
        `learner_age`.
    :ivar text_learner_age_production_aggregated: The age range into
        which the speaker's age at the time of data collection falls. An
        related field in CMSLC is `learner_age`.
    :ivar text_learner_role: Role of the person in this event . There is
        no related field in CMSLC .
    """
    class Meta:
        name = "Text_Learner"

    text_learner_age_production: Optional[Union[int, NaString]] = field(
        default=None,
        metadata={
...
class TextProficiency:
    ...
    :ivar text_proficiency_official_language_testing_score: Results of
        ...
        metadata) A related field in CMSLC is
        `text_official_language_testing_score`.
    :ivar text_proficiency_score: Proficiency score or level for the
        text (not harmonised across DAKODA corpora) A related field in
        CMSLC is `text_proficiency`.
    """
    class Meta:
    ...
    text_proficiency_cefr_autom: CoarseCefrLevel = field(
        default=CoarseCefrLevel.NOT_AVAILABLE,
        metadata={
            "name": "text_proficiency_cefrAutom",
            "type": "Element",
            "required": True,
        }
    )
...
class Annotator:
    ...
    :ivar annotator_id: Unique identifier for manual annotator A related
        field in CMSLC is `annotator_id`.
    :ivar annotator_l1: Annotator L1 A related field in CMSLC is
        `annotator_L1`.
    :ivar annotator_l2: Annotator L2 A related field in CMSLC is
        `annotator_`L2.
    :ivar annotator_note: A related field in CMSLC is `annotator_note`.
    :ivar annotator_target_language_competence: A related field in CMSLC
        is annotator_target_language_competence.
    :ivar annotator_type: A related field in CMSLC is `annotator_type`.
    """
    ...
    annotator_note: Optional[str] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class CorpusDesign:
    """
    :ivar corpus_design_description: A short (non-empty) description of
        the corpus. There is an equivalent field `corpus_description` in
        CMSLC.
    :ivar corpus_design_design_type: Design of data collection/study
        design characterized by a value from a pre-defined enumeration
        of types. A related field in CMSLC is `corpus_longitudinal`.
    :ivar corpus_design_group: Group of corpora that the corpus in
        question is a part of. CMSLC has a comparable field called
        `corpus_related`.
    :ivar corpus_design_is_comparable_data_included: Does the corpus
        include comparison data: yes or no? Comparison data typically
        refers to productions by native speakers or expert writers, etc.
        The CMSLC has a related field `corpus_comparable_data_included`.
    :ivar corpus_design_l1_language: First language(s) of the
        participants. An eqivalent field in CMSLC is
        `corpus_L1_language`.
    :ivar corpus_design_l1_type: L1 constellation among the
        participants. If all participants share one L1: mono; if there
        are multiple L1s: multi . There is no eqivalent field in CMSLC.
    :ivar corpus_design_size: Storage requirement in KB, MB, GB, TB or
        PB .
    :ivar corpus_design_target_language: Specification of the target
        language in the corpus as a value followig ISO 639-3. For the
        Dakoda project this is German in all cases. A related field in
        CMSLC is `corpus_target_language`.
    ...
    :ivar corpus_design_time_of_data_collection: The year or span of
        ...
        in CMSLC is `corpus_time_of_data_collection`.
    """
    class Meta:
        name = "Corpus_Design"
...
class InteractionBlock:
    """
    :ivar task_interaction_conceptual_mode: Conceptual mode in which
        data production took place: spoken/oral or written. This
        reflects Koch und Österreichers model of proximity (conceptual
        orality) and distance (conceptual literacy). A related field in
        CMSLC is `situation_medium`.
    :ivar task_interaction_expected_rhetorical_functions: The
        communicative purpose of the task; the rhetorical functions that
        need to be performed to complete the task. An equivalent field
        in CMSLC is `situation_purpose`.
    :ivar task_interaction_formality: Formality level of the task There
        is no related field in CMSLC .
    :ivar task_interaction_mode:
    :ivar task_interaction_participants_l1_l2_interaction: Type of
        interaction. There is no related field in CMSLC.
    :ivar task_interaction_participants: Number of speakers/writers
        involved in the production of a text. CMSLC has a related field
        `corpus_single_or_multi_author`.
    :ivar task_interaction_type: The modality (e.g. spoken, written) in
        which the task was performed . An equivalent field in CMSLC is
        `situation_register`.
    """
    class Meta:
    ...
    task_interaction_mode: Optional[TaskInteractionMode] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class LanguageOfSpeaker:
    ...
    :ivar learner_language_iso639_3: Depending on the context, this
        ...
        the target language.
    :ivar learner_language_status: There is no related field in CMSLC .
    ...
    learner_language_is_spoken_home: List[bool] = field(
        default_factory=list,
        metadata={
    ...
    learner_language_is_spoken_school: List[bool] = field(
        default_factory=list,
        metadata={
...
class TextProperties:
    """
    :ivar text_file: Shared ID for files related to learner production
        (copies of handwritten texts in pdf, transcriptions, sound
        files, videos, etc.) A related field in CMSLC is `text_file.
    :ivar text_id: Unique identifier for the text within the Dakoda
        corpus. A related field in CMSLC is `text_id`.
    :ivar text_id_orig: Unique identifier(s) for the text within the
        source corpus. A related field in CMSLC is `text_id`.
    :ivar text_language: The target language of the text. An eqivalent
        field in CMSLC is `text_language`.
    :ivar text_longitudinal_order: Number that reflects a particular
        iteration in cas the text was collected as part of a sequence of
        longitudinally collected data. There is no related field in
        CMSLC .
    :ivar text_time_of_creation: Time of creation A related field in
        CMSLC is `text_time_of_creation`.
    :ivar text_token_count: The number of tokens in the text. An
        eqivalent field in CMSLC is `text_token_count`.
    :ivar text_clause_count: Number of sentences There is no related
        field in CMSLC .
    :ivar text_topic_autom: Automatically assigned topic of the text . A
        related field in CMSLC is `situation_topic_domain`.
    :ivar text_note: Any comments on the text and its origins A related
        field in CMSLC is `text_note`.
    :ivar learner:
    :ivar proficiency:
    :ivar annotation:
    """
    ...
    text_time_of_creation: Union[XmlDate, NaString] = field(
        default=NaString.NOT_AVAILABLE,
        metadata={
...
class Learner:
    ...
    :ivar learner_text_count: Number of existing texts from this person.
        There is no related field in CMSCL .
    :ivar learner_note: Comments regarding this learner/L1 speaker. A
        related field in CMSCL is `learner_note`.
    ...
    learner_l_count: Union[int, NaString] = field(
        default=NaString.NOT_AVAILABLE,
        metadata={
            "name": "learner_lCount",
            "type": "Element",
    ...
    learner_note: Optional[str] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
...
class TaskBlock:
    """
    :ivar task_id: The ID of the task within the Dakoda corpus. An
        equivalent field in CMSLC is `situation_id`.
    ...
    :ivar task_comparison: Possibility of comparing tasks and time
        points There is no related field in CMSLC .
    :ivar task_description: Short description of the task A related
        field in CMSLC is `task_instructions`.
    :ivar task_description_detailed: Further descriptions with source
        reference A related field in CMSLC is `task_instructions`.
    :ivar task_duration_minutes: Task duration in minutes A related
        field in CMSLC is `task_duration_minutes`.
    :ivar task_instructions: Wording of the task A related field in
        CMSLC is `task_instructions`.
    :ivar task_is_duration_limited: Was the task timed or not? A related
        field in CMSLC is `task_duration`.
    :ivar task_level: CEFR level of the task There is no related field
        in CMSLC .
    :ivar task_official_language_test: Is the task taken part of an
        official assignment? A related field in CMSLC is
        `task_assessed`.
    :ivar task_official_language_test_specific: Official language test
        from which the task originates There is no related field in
        CMSLC .
    :ivar task_options: Were learners able to choose between different
        tasks? There is norelated field in CMSLC .
    ...
    task_level: List[ProficiencyLevel] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "min_occurs": 1,
...
class Document1:
    ...
    annotator: Optional[Annotator] = field(
        default=None,
        metadata={
            "type": "Element",
        }
